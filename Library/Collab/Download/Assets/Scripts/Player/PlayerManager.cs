...
public class PlayerManager : MonoBehaviour
{
   ...
   public static event Delegates.EmptyDelegate PlayerDiedEvent;
    public static event Delegates.IntDelegate PlayerSetUpHealth;
    #endregion
   ...
   private void OnEnable()
   {
      ...
      GameManager.LevelStartEvent += Respawn;
   ...
   private void Respawn()
   {
      m_Data.CurrentHealth = m_Data.MaxHealth;
        ...
        if (PlayerSetUpHealth != null && justDied)
        {
            Debug.Log("Setting up health");
            PlayerSetUpHealth(10);
            justDied = false;
        }
        m_FacingDirection = 1;
      m_GraphicsScript.ResetToIdle();
      UpdateGraphics();
      TurnInputOn();
   ...
   private void Die()
   {
      ...
      m_Collider.enabled = false;
        ...
        Invoke("ResetGraphicsToIdle", 3.2f);
    }

   private void ResetGraphicsToIdle()
   {
      m_GraphicsScript.ResetToIdle();
   }
   #endregion
